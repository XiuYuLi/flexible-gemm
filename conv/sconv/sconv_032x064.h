#define sconv_32x64(add_bias,suffix)   \
__global__ void dk_sconv_32x64##suffix(\
          char *              d_c   ,\
    ...
    *((float*)&bsst_base[0*256])=q0.x;\
    *((float*)&bsst_base[1*256])=q0.y;\
    *((float*)&bsst_base[2*256])=q0.z;\
    *((float*)&bsst_base[3*256])=q0.w;\
    *((float*)&bsst_base[4*256])=q1.x;\
    *((float*)&bsst_base[5*256])=q1.y;\
    *((float*)&bsst_base[6*256])=q1.z;\
    *((float*)&bsst_base[7*256])=q1.w;\
    __syncthreads();\
    ...
    {\
        ...
        *((float*)&asst[2*128])=p2;  \
        *((float*)&asst[3*128])=p3;  \
        *((float*)&bsst[0*256])=q0.x;\
        *((float*)&bsst[1*256])=q0.y;\
        *((float*)&bsst[2*256])=q0.z;\
        *((float*)&bsst[3*256])=q0.w;\
        BOP4x8(c,&a[1],&b[2])\
        b[2]=*((float4*)&bsld[7*0x100+0x00]);\
        a[1]=*((float4*)&asld[7*0x080+0x00]);\
        b[3]=*((float4*)&bsld[7*0x100+0x40]);\
        BOP4x8(c,&a[0],&b[0])\
        *((float*)&bsst[4*256])=q1.x;\
        *((float*)&bsst[5*256])=q1.y;\
        *((float*)&bsst[6*256])=q1.z;\
        *((float*)&bsst[7*256])=q1.w;\
        asld=asld_base+ofs;\
        bsld=bsld_base+ofs;\
        __syncthreads();\
        b[0]=*((float4*)&bsld[0x00]);\
